                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8 mb-12 text-center lg:text-left">
                    ...
                    <div className="lg:col-span-1 flex flex-col items-center lg:items-start">
                        ...
                        <div className="flex justify-center lg:justify-start space-x-3">
                            ...
                            <a href="https://wa.me/919475414545?text=Hi%20Lustomotive%20Team!%0A%0AI%E2%80%99d%20like%20to%20book%20an%20appointment%20for%20my%20vehicle.%0A%0APlease%20let%20me%20know%20the%20available%20slots%20and%20the%20details%20you%20need%20from%20me.%0A%0AThank%20you!" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp" className="w-10 h-10 rounded-lg bg-white/5 border border-white/10 flex items-center justify-center text-gray-400 hover:bg-red-500/15 hover:border-red-500/50 hover:text-red-500 hover:-translate-y-1 transition-all">
