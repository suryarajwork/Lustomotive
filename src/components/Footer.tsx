        ...
        <footer className="relative bg-[#050505] border-t border-red-500/15 overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-8">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8 mb-12 text-center lg:text-left">
                    ...
                    <div className="lg:col-span-1 flex flex-col items-center lg:items-start">
                        ...
                        <div className="flex justify-center lg:justify-start space-x-3">
                            <a href="https://www.instagram.com/lustomotive" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="w-10 h-10 rounded-lg bg-white/5 border border-white/10 flex items-center justify-center text-[#E1306C] hover:bg-[#E1306C]/15 hover:border-[#E1306C]/50 hover:-translate-y-1 transition-all">
                                <Instagram size={18} />
                            </a>
                            <a href="https://www.facebook.com/lustomotive" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="w-10 h-10 rounded-lg bg-white/5 border border-white/10 flex items-center justify-center text-[#1877F2] hover:bg-[#1877F2]/15 hover:border-[#1877F2]/50 hover:-translate-y-1 transition-all">
                                <Facebook size={18} />
                            </a>
                            <a href="https://wa.me/919475414545?text=Hi%20Lustomotive%20Team!%0A%0AI%E2%80%99d%20like%20to%20book%20an%20appointment%20for%20my%20vehicle.%0A%0APlease%20let%20me%20know%20the%20available%20slots%20and%20the%20details%20you%20need%20from%20me.%0A%0AThank%20you!" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp" className="w-10 h-10 rounded-lg bg-white/5 border border-white/10 flex items-center justify-center text-[#25D366] hover:bg-[#25D366]/15 hover:border-[#25D366]/50 hover:-translate-y-1 transition-all">
                            ...
                            <a href="https://maps.app.goo.gl/QEgLTb45cyx8QbW58" target="_blank" rel="noopener noreferrer" aria-label="Google Maps" className="w-10 h-10 rounded-lg bg-white/5 border border-white/10 flex items-center justify-center text-[#EA4335] hover:bg-[#EA4335]/15 hover:border-[#EA4335]/50 hover:-translate-y-1 transition-all">
                                <MapPin size={18} />
                            </a>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-col items-center lg:items-start">
                        <div className="text-center lg:text-left">
                            ...
                            <ul className="flex flex-col gap-2.5 items-center lg:items-start">
                                ...
                                <li>
                                    <Link href="#offers" className="text-gray-400 hover:text-red-500 hover:pl-2 transition-all duration-300 flex items-center gap-2 text-[0.85rem]">
                                        <ChevronRight className="w-3 h-3 text-red-500 hidden lg:block shrink-0" />
                                        Special Offers
                                    </Link>
                                </li>
                        ...
                        <div className="text-center lg:text-left">
                            ...
                            <ul className="flex flex-col gap-3.5 items-center lg:items-start">
                                ...
                                <li className="flex flex-col sm:flex-row items-center gap-2 sm:gap-3 group">
                                    ...
                                    <span className="text-gray-400 text-[0.85rem]">Tue-Sun : 9 AM – 7 PM</span>
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <div className="flex flex-col lg:flex-row items-center justify-between flex-wrap gap-4 text-center">
                    ...
                    <p className="text-gray-500 font-light text-[0.78rem]">
                        Designed by <a href="https://www.suryaraj.vercel.app" target="_blank" rel="noopener noreferrer" className="text-red-500 hover:text-red-400 transition-colors">@Suryaraj</a>
                    </p>
                </div>
            </div>
        </footer>
