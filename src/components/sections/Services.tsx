...
export default function Services() {
    const services = [
        ...
        },
        {
            ...
            description: "Keep your vehicle running at its best with expert mechanical care, reliable repairs, and precision servicing.",
